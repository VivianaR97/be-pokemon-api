...
('6d56a0a1-8739-4a6d-9e1d-7b7d8fa1c816', 'Torrential Heart', 'Once during your turn, you may put 5 damage counters on this Pokémon. If you do, during this turn, attacks used by this Pokémon do 120 more damage to your opponent’s Active Pokémon.', NULL),
...
INSERT INTO card ("id", "name", "type", "rarity", "hp", "weaknessType", "weaknessMultiplier", "resistanceType", "resistanceAmount", "ability", "retreatCost") VALUES
('6a3b5d6a-1234-4d98-a123-0a1234567890', 'Pikachu', 'ELECTRIC', 'COMMON', 60, 'FIGHTING', 2, 'STEEL', 20, NULL, 1),
('9b3f8e8d-2345-4f56-b234-1b2345678901', 'Charizard EX', 'FIRE', 'RARE', 180, 'WATER', 2, NULL, NULL, NULL, 2),
('7c6d9e0e-3456-4b67-c345-2c3456789012', 'Onix', 'FIGHTING', 'COMMON', 90, 'GRASS', 1.5, NULL, NULL, NULL, 3),
('8d7e1f2f-4567-4c78-d456-3d4567890123', 'Feraligatr', 'WATER', 'RARE', 180, 'ELECTRIC', 2, NULL, NULL, 'Once during your turn, you may put 5 damage counters on this Pokémon. If you do, during this turn, attacks used by this Pokémon do 120 more damage to your opponents Active Pokémon (before applying Weakness and Resistance).', 3),
('9e8d0f3e-5678-4d89-e567-4e5678901234', 'Sneasel', 'DARK', 'COMMON', 70, 'GRASS', 2, NULL, NULL, NULL, 2),
('0f9e1d2c-6789-4e90-f678-5f6789012345', 'Scizor', 'STEEL', 'RARE', 120, 'FIRE', 2, 'PSYCHIC', 20, 'This Pokémon takes 30 less damage from attacks (after applying Weakness and Resistance).', 1),
('1f0e2d3c-7890-4f01-b789-6f7890123456', 'Treecko', 'PSYCHIC', 'COMMON', 40, 'FIRE', 1.5, 'WATER', 30, NULL, 1);
...
('8d7e1f2f-4567-4c78-d456-3d4567890123', '6d56a0a1-8739-4a6d-9e1d-7b7d8fa1c816'),
